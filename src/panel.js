  ...
  showModal(`
    ...
    <div class="modal-body help-body">
      ...
      <ol class="help-steps">
        ...
        <li><b>改行程</b>：拖动停留点卡片可调顺序（有位置指示线，整列任意位置可松手）；拖到顶部日期签可直接移动到那一天；「⧉」把地点复制到任意一天（含本天——环线日出发/返回同一酒店时，复制两个到当天开头/末尾即可）；「📍 添加地点」在地图上点一下即可插入新点；「📚 地点库」收录了三亚/陵水/万宁/中部山区等约 38 个常用地点，顶部还列出方案里已有地点可一键复用。</li>
